...
def calculate_grade(score, grade_c, grade_b, grade_a):
    try:
        ...
        print("Error: Invalid grade values. Please provide numeric values for grading.")
        return "Error"
def get_test_score(prompt):
    while True:
        try:
            ...
            print("Error: Please enter a valid integer for the test score.")
...
def main():
    english_test1 = get_test_score("Enter English Test 1 score: ")
    english_test2 = get_test_score("Enter English Test 2 score: ")
    english_average, english_final_grade = english_grades(english_test1, english_test2)

    maths_test1 = get_test_score("Enter Maths Test 1 score: ")
    maths_test2 = get_test_score("Enter Maths Test 2 score: ")
    maths_test3 = get_test_score("Enter Maths Test 3 score: ")
    maths_average, maths_final_grade = maths_grades(maths_test1, maths_test2, maths_test3)

    science_test1 = get_test_score("Enter Science Test 1 score: ")
    science_test2 = get_test_score("Enter Science Test 2 score: ")
    science_test3 = get_test_score("Enter Science Test 3 score: ")
